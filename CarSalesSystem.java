...
public class CarSalesSystem extends JFrame implements ActionListener, ComponentListener, ChangeListener
{
	...
	private JLabel carCoLabel = new JLabel("SS Car Company", JLabel.CENTER);
	private JLabel salesSysLabel = new JLabel("Car Sales", JLabel.CENTER);
	...
	public CarSalesSystem(String f)
	{
		...
		pictureLabel.setIcon(new ImageIcon("fastcar.png"));
		...
		theTab.add("Search on age of Car", searchByAgePanel);
